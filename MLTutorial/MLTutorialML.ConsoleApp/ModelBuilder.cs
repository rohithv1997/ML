...
namespace MLTutorialML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"G:\Rohith\Coding\ML\MLTutorial\MLTutorial\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../MLTutorialML.Model/MLModel.zip";
